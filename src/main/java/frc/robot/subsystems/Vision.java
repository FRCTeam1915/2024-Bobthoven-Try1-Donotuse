...
public class Vision extends SubsystemBase {
  ...
  public Vision() {
    ...
    // m_isTargetValid = Shuffleboard.getInstance().getTargetEntry();
    Shuffleboard.getTab("limelight").add("Target Valid", false);
  ...
  public void periodic() {
    ...
    Shuffleboard.getTab("limelight").add("Target Valid", isTargetValid());
