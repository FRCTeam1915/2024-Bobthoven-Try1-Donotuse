...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public double getRobotForceNewtons(){
    return(57.0 * 9.8 * gyro.getAccelX());
  }
  ...
  SmartDashboard.putNumber("Robot Acceleration X", gyro.getAccelX());
  SmartDashboard.putNumber("Robot Acceleration Y", gyro.getAccelY());
  SmartDashboard.putNumber("Robot Force X Newtons", 57.0 * 9.8 * gyro.getAccelX());
  SmartDashboard.putNumber("Robot Force X Pounds", (57.0 * 9.8 * gyro.getAccelX()) / 4.45);
