...
public final class Constants {
    ...
    public static final class AutoConstants {
        ...
        public static final PathConstraints generatedPathConstraints = new PathConstraints(kMaxAngularSpeedRadiansPerSecond, kMaxAccelerationMetersPerSecondSquared, kMaxAccelerationMetersPerSecondSquared, kMaxAngularAccelerationRadiansPerSecondSquared);
